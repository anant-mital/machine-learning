...
class TaxiEnv(discrete.DiscreteEnv):
    ...
    When the episode starts, the taxi starts off at a random square and the passenger
    is at a random location.
    ...
    Observations: 
    There are 500 discrete actions since there are 25 taxi positions, 
